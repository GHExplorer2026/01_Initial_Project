...
| T-104 | Run GitHub `Release Gate` workflow on `main` and archive artifacts | High | In Progress | Triggered; awaiting run URL/artifacts verification | 2026-02-15 | Codex/User |
