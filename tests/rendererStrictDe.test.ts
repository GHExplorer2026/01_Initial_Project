...
describe("renderStrictWeeklyText", () => {
  ...
  it("uses fixed region label mapping in rendered event lines", () => {
    ...
    const events: GroupedRenderEvent[] = [
      { region: "USA", day: "2026-02-09", timeHHMM: "08:00", title: "E1", isTopEvent: false, datetimeBerlinISO: "2026-02-09T08:00:00" },
      { region: "EZ", day: "2026-02-09", timeHHMM: "08:01", title: "E2", isTopEvent: false, datetimeBerlinISO: "2026-02-09T08:01:00" },
      { region: "UK", day: "2026-02-09", timeHHMM: "08:02", title: "E3", isTopEvent: false, datetimeBerlinISO: "2026-02-09T08:02:00" },
      { region: "JP", day: "2026-02-09", timeHHMM: "08:03", title: "E4", isTopEvent: false, datetimeBerlinISO: "2026-02-09T08:03:00" },
      { region: "CH", day: "2026-02-09", timeHHMM: "08:04", title: "E5", isTopEvent: false, datetimeBerlinISO: "2026-02-09T08:04:00" },
      { region: "CA", day: "2026-02-09", timeHHMM: "08:05", title: "E6", isTopEvent: false, datetimeBerlinISO: "2026-02-09T08:05:00" },
      { region: "AU", day: "2026-02-09", timeHHMM: "08:06", title: "E7", isTopEvent: false, datetimeBerlinISO: "2026-02-09T08:06:00" },
      { region: "NZ", day: "2026-02-09", timeHHMM: "08:07", title: "E8", isTopEvent: false, datetimeBerlinISO: "2026-02-09T08:07:00" }
    ];
